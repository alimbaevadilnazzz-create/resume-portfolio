...
const translations = {
    ru: {
        ...
        hero_greeting: "hola!",
        hero_text: "Я — <strong class=\"highlight-text\">Дильназ</strong>! ❤️<br>Моя суперсила: соединять людей, процессы и технологии. Люблю превращать хаос в ясность, а идеи - в продукты, которыми хочется пользоваться. Верю, что лучшие продукты рождаются на стыке технологий, креативности и сильных команд",
        btn_tg: "Перейти в tg",
        btn_about: "Обо мне",
    ...
    en: {
        ...
        hero_greeting: "hello!",
        hero_text: "I’m <strong class=\"highlight-text\">Dilnaz</strong>! ❤️<br>My superpower: connecting people, processes, and technology. I love turning chaos into clarity, and ideas - into products people want to use. I believe the best products are born where technology, creativity, and strong teams come together",
