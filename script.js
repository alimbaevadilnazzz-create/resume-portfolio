...
const translations = {
    ru: {
        ...
        hero_greeting: "hola!",
        hero_text: "Я — <strong class=\"highlight-text\">Дильназ</strong>, Scrum-мастер с продуктовым и проектным мышлением. Я помогаю командам превращать идеи в эффективные цифровые продукты: выстраиваю продуктивные процессы, синхронизирую бизнес, разработку и дизайн, а также помогаю кросс-функциональным командам двигаться быстрее и приносить пользу. Благодаря сильной технической базе в области информационных систем, я легко связываю технологии, бизнес и пользовательский опыт для создания продуктов, которые решают реальные проблемы и приносят ценность.",
        btn_tg: "Перейти в tg",
        btn_about: "Обо мне",
    ...
    en: {
        ...
        hero_greeting: "hello!",
        hero_text: "I’m <strong class=\"highlight-text\">Dilnaz</strong>, a Scrum Master with a Product and Project Management mindset. I help teams turn ideas into impactful digital products by building efficient processes, aligning business, engineering, and design, and enabling cross-functional teams to move fast and deliver value. With a strong technical background in Information Systems, I bridge the gap between technology, business, and user experience to create products that solve real problems and deliver meaningful value.",
    ...
    kk: {
        ...
        hero_greeting: "сәлем!",
        hero_text: "Мен — өнімдік және жобалық ойлау қабілеті бар Scrum-мастер <strong class=\"highlight-text\">Дильназбын</strong>. Командаларға идеяларды тиімді цифрлық өнімдерге айналдыруға көмектесемін: өнімді процестерді құрамын, бизнес, әзірлеу мен дизайнды үйлестіремін және кросс-функционалды командалардың жылдам әрі нәтижелі жұмыс істеуіне жағдай жасаймын. Ақпараттық жүйелер саласындағы мықты техникалық базаның арқасында нақты мәселелерді шешетін және құндылық әкелетін өнімдер жасау үшін технология, бизнес және пайдаланушы тәжірибесін оңай байланыстырамын.",
